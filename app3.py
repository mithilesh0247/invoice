...
# Creating Canvas
c = canvas.Canvas("invoice.pdf",pagesize=(216,279),bottomup=0)
# Logo Section
...
c.drawCentredString(125,20,"Zekardo Atomative Pvt.Ltd ")
# For under lining the title
c.line(70,22,180,22)
# Changing the font size for Specifying Address
c.setFont("Helvetica-Bold",5)
c.drawCentredString(125,30,"Registered Address: 2964, Block C1, Sushant Lok1,")
c.drawCentredString(125,35," Gurgaon 122002, Haryana, INDIA")
...
c.drawRightString(80,70,str(i))
c.drawRightString(70,80,"DATE :")
c.drawRightString(100,80,str(today))
